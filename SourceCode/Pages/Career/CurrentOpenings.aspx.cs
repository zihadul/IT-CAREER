...
public partial class Pages_Career_CurrentOpenings : BasePage
{
    #region Members
    ...
    private void BindData()
    {
        ...
        DataTable dt = objCareerJob.GetActive(CurrentPage * gv.PageSize, gv.PageSize, Criteria, PrintMode);
    ...
    private void BindData(string sortExpression, string direction)
    {
        ...
        plcPaging.Controls.Clear();
        DataView dv = objCareerJob.GetActive(CurrentPage * gv.PageSize, gv.PageSize, Criteria, PrintMode).DefaultView;
