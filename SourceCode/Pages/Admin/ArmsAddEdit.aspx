<%@ Page Title="Add/Edit Arms" Language="C#" MasterPageFile="~/Master_Pages/Admin.master" AutoEventWireup="true" CodeFile="ArmsAddEdit.aspx.cs" Inherits="Pages_Admin_ArmsAddEdit" %>
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <asp:Button ID="Button1" runat="server" Text="Back" CausesValidation="false" Width="60"
                            Height="25" PostBackUrl="~/Pages/Admin/Arms.aspx" />
                    </td>
                </tr>
            </table>
            </asp:Panel>
